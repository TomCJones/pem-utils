...
namespace DerConverter.Tests.Asn
{
    ...
    public class DefaultDerAsnDecoderTests
    {
        ...
        [TestCase(typeof(DerAsnPrintableString), new byte[] { 0x13, 0x04, 0x74, 0x65, 0x73, 0x74 })]
        [TestCase(typeof(DerAsnUtcTime), new byte[] { 0x17, 0x0D, 0x39, 0x31, 0x30, 0x35, 0x30, 0x36, 0x32, 0x33, 0x34, 0x35, 0x34, 0x30, 0x5A })]
        [TestCase(typeof(DerAsnIa5String), new byte[] { 0x16, 0x04, 0x74, 0x65, 0x73, 0x74 })]
        [TestCase(typeof(DerAsnContext), new byte[] { 0x30, 0x0D, 0x06, 0x09, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x01, 0x05, 0x00 })]
